...
@EnableJpaRepositories(basePackages = "com.gm.examples.springbootsecurityrestdata.repository")
public class DataSourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(@Qualifier("datasource") DataSource ds)
		...
		entityManagerFactory.setPackagesToScan(new String[] { "com.gm.examples.springbootsecurityrestdata.domain" });
